...
FVkTextureApplication::FVkTextureApplication()
...
void FVkTextureApplication::AddResizeCallback()
{
...
void FVkTextureApplication::CreateInstance()
{
...
void FVkTextureApplication::SetupDebugMessenger()
{
	if (ENABLE_VALIDATION_LAYERS)
	{
		VkDebugUtilsMessengerCreateInfoEXT DebugMessengerCI{};
...
void FVkTextureApplication::CreateSurface()
{
	GLFWwindow* Window = GEngine->GetWindow();
	assert(Window != nullptr);
...
void FVkTextureApplication::PickPhysicalDevice()
{
...
void FVkTextureApplication::CreateLogicalDevice()
{
...
void FVkTextureApplication::CreateSwapchain()
{
...
void FVkTextureApplication::CreateImageViews()
{
...
void FVkTextureApplication::CreateRenderPass()
{
...
void FVkTextureApplication::CreateDescriptorSetLayout()
{
...
void FVkTextureApplication::CreateGraphicsPipeline()
{
...
void FVkTextureApplication::CreateFramebuffers()
{
...
void FVkTextureApplication::CreateCommandPool()
{
	uint32_t GraphicsFamily = -1;
	uint32_t PresentFamily = -1;
	Vk::FindQueueFamilies(PhysicalDevice, Surface, GraphicsFamily, PresentFamily);
...
void FVkTextureApplication::CreateTextureImage()
{
...
void FVkTextureApplication::CreateVertexBuffer()
{
...
void FVkTextureApplication::CreateIndexBuffer()
{
...
void FVkTextureApplication::CreateUniformBuffers()
{
}

void FVkTextureApplication::CreateDescriptorPool()
{
...
void FVkTextureApplication::CreateDescriptorSets()
{
...
void FVkTextureApplication::CreateCommandBuffers()
{
...
void FVkTextureApplication::CreateSyncObjects()
{
...
void FVkTextureApplication::WaitIdle()
{
	vkDeviceWaitIdle(Device);
}

void FVkTextureApplication::RecordCommandBuffer(VkCommandBuffer InCommandBuffer, uint32_t InImageIndex)
{
...
void FVkTextureApplication::RecreateSwapchain()
{
	GLFWwindow* Window = GEngine->GetWindow();
	assert(Window != nullptr);
...
void FVkTextureApplication::CleanupSwapchain()
{
...
void FVkTextureApplication::Render()
{
...
void FVkTextureApplication::Cleanup()
{
	CleanupSwapchain();
