...
FVkCubeApplication::FVkCubeApplication()
	: GValidationLayers({ "VK_LAYER_KHRONOS_validation" })
	, GDeviceExtensions({ VK_KHR_SWAPCHAIN_EXTENSION_NAME })
	...
	, GIndexBuffer(VK_NULL_HANDLE)
	, GIndexBufferMemory(VK_NULL_HANDLE)
	, GCurrentFrame(0)
	, GVertices({
...
void FVkCubeApplication::AddResizeCallback()
{
	glfwSetFramebufferSizeCallback(GEngine->GetWindow(), FramebufferResizeCallback);
}

void FVkCubeApplication::CreateInstance()
{
	if (ENABLE_VALIDATION_LAYERS && !Vk::SupportsValidationLayer(GValidationLayers))
	{
...
void FVkCubeApplication::SetupDebugMessenger()
{
	if (ENABLE_VALIDATION_LAYERS)
	{
		VkDebugUtilsMessengerCreateInfoEXT DebugMessengerCI{};
...
void FVkCubeApplication::CreateSurface()
{
...
void FVkCubeApplication::PickPhysicalDevice()
{
...
void FVkCubeApplication::CreateLogicalDevice()
{
...
void FVkCubeApplication::CreateSwapchain()
{
...
void FVkCubeApplication::CreateImageViews()
{
...
void FVkCubeApplication::CreateRenderPass()
{
...
void FVkCubeApplication::CreateDescriptorSetLayout()
{
...
void FVkCubeApplication::CreateGraphicsPipeline()
{
...
void FVkCubeApplication::CreateFramebuffers()
{
...
void FVkCubeApplication::CreateCommandPool()
{
	uint32_t GraphicsFamily = -1;
	uint32_t PresentFamily = -1;
	Vk::FindQueueFamilies(GPhysicalDevice, GSurface, GraphicsFamily, PresentFamily);
...
void FVkCubeApplication::CreateTextureImage()
{
...
void FVkCubeApplication::CreateVertexBuffer()
{
...
void FVkCubeApplication::CreateIndexBuffer()
{
...
void FVkCubeApplication::CreateUniformBuffers()
{
...
void FVkCubeApplication::CreateDescriptorPool()
{
...
void FVkCubeApplication::CreateDescriptorSets()
{
...
void FVkCubeApplication::CreateCommandBuffers()
{
...
void FVkCubeApplication::CreateSyncObjects()
{
...
void FVkCubeApplication::WaitIdle()
{
	vkDeviceWaitIdle(GDevice);
}

void FVkCubeApplication::RecordCommandBuffer(VkCommandBuffer InCommandBuffer, uint32_t InImageIndex)
{
...
void FVkCubeApplication::RecreateSwapchain()
{
	GLFWwindow* Window = GEngine->GetWindow();
	assert(Window != nullptr);
...
void FVkCubeApplication::CleanupSwapchain()
{
...
void FVkCubeApplication::UpdateUniformBuffer()
{
...
void FVkCubeApplication::Render(float InDeltaTime)
{
...
void FVkCubeApplication::Cleanup()
{
	CleanupSwapchain();
