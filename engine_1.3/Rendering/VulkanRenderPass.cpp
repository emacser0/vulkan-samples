...
FVulkanRenderPass* FVulkanRenderPass::CreateSkyPass(FVulkanContext* InContext)
{
...
FVulkanRenderPass* FVulkanRenderPass::CreateUIPass(FVulkanContext* InContext)
{
	return CreateBasePass_Internal(InContext, false);
}

FVulkanRenderPass* FVulkanRenderPass::CreateBasePass_Internal(FVulkanContext* InContext, bool bFirstPass)
{
	FVulkanViewport* Viewport = InContext->GetViewport();
